...
| 19 | [restful api crud operations](https://github.com/anirudha-8/19-rest-api-crud-operation-node-problem.git) | Build a Restful API which performs CRUD operations. |
| 20 | [pug - template engine](https://github.com/anirudha-8/20-template-engine-pug-node-problem.git) | Create an Express server using the **Pug** template engine to render a dynamic HTML page. |
